...
export const menu1 = [
  ...
  { title: "1.4 Rutherford Grade & Personal History ", path: "/RutherfordGrade" },
  ...
  { title: "1.3 Neuropathy", path: "/Neuropathy" },
  { title: "1.4 DNS Score", path: "/DNS Score" },
  { title: "1.5 Rutherford Grade ", path: "/Rutherford Grade" },
  { title: "1.6 Personal History", path: "/Personal History" },
  { title: "1.1 Personal Information", path: "/" },
  { title: "1.2 Diabetic Complications", path: "/DiabeticComplications" },
  { title: "1.3 Neuropathy", path: "/Neuropathy" },
